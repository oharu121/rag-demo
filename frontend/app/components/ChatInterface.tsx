      ...
      <div className="flex flex-col h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
        ...
        <header className="shrink-0 glass border-b border-white/20 shadow-sm sticky top-0 z-30">
          <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
            <div className="animate-fade-in">
              ...
              <p className="text-sm text-gray-500 mt-0.5">{UI_TEXT.appSubtitle}</p>
            </div>
            <button
        ...
        <main className="flex-1 overflow-y-auto">
          <div className="max-w-4xl mx-auto px-6 py-8">
            ...
            {error && (
              <div className="mb-6 p-4 bg-gradient-to-r from-red-50 to-rose-50 border border-red-200/60
            ...
            {messages.length === 0 && (
              <div className="text-center py-16 animate-fade-in-up">
                <div className="relative w-24 h-24 mx-auto mb-6">
                  ...
                  {/* Icon container */}
                  <div className="relative w-full h-full bg-gradient-to-br from-blue-500 to-indigo-600
                ...
                <p className="text-gray-500 max-w-md mx-auto leading-relaxed">
                  ...
                  <br />
                  <span className="text-gray-400">右上のボタンからドキュメントを追加することもできます。</span>
                </p>
                {/* Suggested prompts */}
                <div className="mt-8 flex flex-wrap justify-center gap-3">
                  {["会社の休暇制度について教えて", "リモートワークのポリシーは?", "経費精算の方法は?"].map((prompt, i) => (
                    <button
                      key={i}
